...
function showCart(array){
    ...
    for(i=0; i<array.length; i++){
        ...
        html+= `
        <tr>
        <th class="align-middle align-center" scope="row"><img style='height:4em' src='${article.src}' alt='${article.src}' class="img-thumbnail"></th>
        ...
        <div>
                      <div class="def-number-input number-input btn-group">
                        ...
                        <input class="quantity" min="1" name="contador[${i}]" value="${article.count}" type="number" id="contador${i}" style="width:3em; text-align:center">
